...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/
// 07feae11780495b90145451d48d4a50923762ef1/react-router/react-router.d.ts
...
declare namespace ReactRouter {
  ...
  /** Fixed router, that present in MatchState, but not found in original d.ts (and make createElement optional) */
  interface MatchStateFix extends MatchState {
    createElement?: (component: RouteComponent, props: Object) => any;
    router: any;
  }
  //function match(args: MatchArgs, cb: (error: any, nextLocation: H.Location, nextState: MatchState) => void): void
  function match(args: MatchArgs, cb: (error: any, nextLocation: H.Location, nextState: MatchStateFix) => void): void
